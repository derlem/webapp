...
def word2vec_view(request):
    ...
    # data = [[('kanser', 0.4449951946735382), ('verem', 0.4244382679462433),('kamil',0.3),('kanser', 0.4449951946735382), ('verem', 0.4244382679462433),('kamil',0.3),('kanser', 0.4449951946735382), ('verem', 0.4244382679462433),('kamil',0.3),('kanser', 0.4449951946735382), ('verem', 0.4244382679462433),('kamil',0.3),('kanser', 0.4449951946735382), ('verem', 0.4244382679462433),('kamil',0.3),('kanser', 0.4449951946735382), ('verem', 0.4244382679462433),('kamil',0.3)], '503']
    #
    # chart_data = []
    # chart_data.append(['Most Similar Words', 'wordasdsadasdasdsadsadsads sax'])
    #
